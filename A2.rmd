...
incfeel_hist <- gssdata %>% 
  ...
  geom_text(aes(label = scales::percent(round(..prop.., 3)), y= ..prop..), stat= "count", vjust = -.5, size = 1.5) + 
  ...
  theme_minimal() + theme(plot.title = element_text(hjust = 0.5), plot.caption = element_text(hjust = 0.5))
